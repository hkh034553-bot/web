...
- **Team:** edit the `TEAM` array in `src/components/TeamSection.tsx`. Add an `image` field with a path like `"/team/hasan.jpg"` to show a real photo; otherwise a branded initials tile shows.
